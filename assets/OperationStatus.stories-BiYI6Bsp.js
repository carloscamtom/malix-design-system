import{R as e}from"./index-Bc2G9s8g.js";/* empty css               */import{O as a}from"./GlassPopover-ABZWYFm7.js";const R={title:"Malix/OperationStatus",component:a,args:{status:"active"}},s={args:{status:"active"}},t={args:{status:"completed"}},r={args:{status:"failed"}},o={args:{status:"pending"}},c={args:{status:"active",label:"Processing..."}},n={render:()=>e.createElement("div",{style:{display:"flex",gap:16,flexWrap:"wrap"}},e.createElement(a,{status:"active"}),e.createElement(a,{status:"completed"}),e.createElement(a,{status:"failed"}),e.createElement(a,{status:"pending"}))};var p,i,u;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    status: 'active'
  }
