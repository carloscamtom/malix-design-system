import{R as e}from"./index-Bc2G9s8g.js";/* empty css               */import{k as p}from"./GlassPopover-ABZWYFm7.js";const w={title:"Malix/Stepper",component:p,args:{steps:[{label:"Account",status:"completed"},{label:"Profile",status:"active"},{label:"Review",status:"pending"}]}},t={},s={args:{steps:[{label:"Account",status:"completed"},{label:"Profile",status:"completed"},{label:"Review",status:"completed"}]}},a={args:{steps:[{label:"Account",status:"pending"},{label:"Profile",status:"pending"},{label:"Review",status:"pending"}]}},n={args:{steps:[{label:"Details",status:"completed"},{label:"Address",status:"completed"},{label:"Payment",status:"active"},{label:"Confirm",status:"pending"}]}},l={render:()=>e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:32}},e.createElement(p,{steps:[{label:"Step 1",status:"completed"},{label:"Step 2",status:"completed"},{label:"Step 3",status:"completed"}]}),e.createElement(p,{steps:[{label:"Step 1",status:"completed"},{label:"Step 2",status:"active"},{label:"Step 3",status:"pending"}]}),e.createElement(p,{steps:[{label:"Step 1",status:"pending"},{label:"Step 2",status:"pending"},{label:"Step 3",status:"pending"}]}))};var r,o,c;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:"{}",...(c=(o=t.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var u,d,i;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    steps: [{
      label: 'Account',
      status: 'completed'
