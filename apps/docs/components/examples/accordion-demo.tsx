...
import { Accordion } from '@malix/ui';

export function AccordionDemo() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <Accordion title="Getting started" defaultOpen>
        <p>Follow the installation guide to set up the design system in your project. Import components from the @malix/ui package.</p>
      </Accordion>
