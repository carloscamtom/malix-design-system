...
function ComponentCard({ component }: { component: ComponentMeta }) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-xl border border-fd-border bg-fd-card no-underline transition-all hover:border-fd-foreground/20 hover:shadow-md"
    >
      {/* Visual preview area */}
      ...
      <div className="px-4 py-3">
        <h3 className="text-sm font-medium text-fd-foreground no-underline">
          {component.name}
        </h3>
